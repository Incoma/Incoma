...
$sqlnode = 'INSERT INTO nodes_'.$conversation.
	'( hash  , content , evalpos , evalneg , evaluatedby , type , author , time) '.
	'VALUES ( '.$newnodephparray[1].' , "'.$newnodephparray[3].'" , '.$newnodephparray[5].' , '.$newnodephparray[7].' , "'.$newnodephparray[9].'" , '.$newnodephparray[11].'  , "'.$newnodephparray[13].'" , "'.time().'" )';
