...
$sqllink = 'INSERT INTO links_'.$conversation.
	'( hash  , source , target, direct, evalpos , evalneg , evaluatedby , type , author , time) '.
	'VALUES ( '.$newlinkphparray[1].' , '.$newlinkphparray[3].' , '.$newlinkphparray[5].' , '.$newlinkphparray[7].' , '.$newlinkphparray[9].' , '.$newlinkphparray[11].'  , "'.$newlinkphparray[13].'" , '.$newlinkphparray[15].', "'.$newlinkphparray[17].'", '.time().' )';
