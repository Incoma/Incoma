					...
					<center>  \
						<div class="big_panel noselect">  \
						  <center>  \
							...
							<div class="big_label noselect">Aprende y experimenta</div>   \
						   </center>   \
						 </div>   \
						<div class="big_panel noselect">    \
						  <center>  \
					  ...
					  <div id="join_panel" class="huge_panel_2 noselect">   \
						...
						<div class="bt_panel2 noselect">  \
							<center>  \
								...
								<div id="bt_join_cancel" onclick="bt_cancel()" class="conv_cancel button">Cancelar</div>  \
							</center>  \
						</div>  \
					  </div>   \
					  \
					  <div id="new_panel" class="huge_panel_3 noselect">   \
						...
						<div class="radiosel">  \
							...
							<center>  \
								...
								<div id="bt_new_cancel" onclick="bt_cancel()" class="conv_cancel button">Cancelar</div>  \
							</center>  \
							</div>  \
					  </div>   \
			  </div>   \
...
function prepareconvlistselect(){
	...
	for (var i=0;i<conversationlist.length;i++){
		...
		ddData.push({
			...
			value: i,
			selected:false,
			description: conversationlist[i].thoughtnum + " pensamientos&nbsp&nbsp&nbsp Creada: " + timeAgo(conversationlist[i].creationtime) + "&nbsp&nbsp&nbsp Última actividad: " + timeAgo(conversationlist[i].lasttime) + "&nbsp&nbsp&nbsp Idioma: " + idioma, 
		});
	}
...
function preparelangselect(){
	...
	var ddData = [
		...
		{text: "Español", text2: "Spanish", value: 1, selected: true}, 
		{text: "Inglés", text2: "English", value: 2, selected: false},
		{text: "------------------", text2: "------------------", value: 3, selected: false}
	];
	...
	$('#selectlanguage').ddTslick({
		...
		onSelected: function(selectedData){
			...
			convlanguage = ddData[selectedData.selectedIndex].text2;
...
function preparelangfilter(){
	...
	for (i in languageslist){
		ddData.push({text: languageslist[i].name, text2: languageslist[i].name, value: j, selected: false});
		j++;
	}
	...
	$('#languagefilter').ddTslick({
		...
		onSelected: function(selectedData){
			...
			langfilter = ddData[selectedData.selectedIndex].text2;
